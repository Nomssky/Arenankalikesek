-- Booking belum dibayar hanya menjadi hold. Resource baru menjadi jadwal aktif
-- setelah status booking berubah menjadi paid/confirmed melalui webhook/admin.
...
-- Ubah resource pending lama menjadi hold sebelum constraint overlap dibuat ulang.
...
-- Baris hold hanya menyimpan detail transaksi pending dan tidak memblokir slot.
-- Pemeriksaan overlap dijalankan saat resource berubah menjadi active setelah paid.
